...
# instalación 
1. si no eres mi novia, me veo en la obligación de pedirte encarecidamente que leas todas las instrucciones primero, gracias.
2. instala debian 12 (bookworm) sin entorno de escritorio, con utilidades estándar de sistema y el paquete de servidor ssh.
3. ejecuta esta línea de comandos, que instala git, descarga el script de instalación de mi setup, lo vuelve ejecutable y lo instala.
```
